...
export const FORM_FIELDS_ADD_BOOKING: FormFieldConfigModel<BookingModel>[] = [
  ...
  { formKey: 'client_phone', label: 'Phone', size: 6, type: 'textfield', allowsDisabled: false, allowsEnabled: true },
  { formKey: 'client_email', label: 'Email', size: 6, type: 'textfield', allowsDisabled: false, allowsEnabled: true },
...
export const FORM_FIELDS_EDIT_BOOKING: FormFieldConfigModel<BookingModel>[] = [
  { formKey: 'client_name', label: 'Name', size: 6, type: 'textfield', allowsEnabled: false, allowsDisabled: true },
  { formKey: 'client_surname', label: 'Surname(s)', size: 6, type: 'textfield', allowsEnabled: false, allowsDisabled: true },
  { formKey: 'client_phone', label: 'Phone', size: 6, type: 'textfield', allowsEnabled: false, allowsDisabled: true },
  { formKey: 'client_email', label: 'Email', size: 6, type: 'textfield', allowsEnabled: false, allowsDisabled: true },
  { formKey: "start_time", label: "Date & Time", size: 6, type: "datepicker", allowsEnabled:true, allowsDisabled: true, defaultEnabled: false },
  { formKey: 'duration', label: 'Duration', size: 6, type: 'select', elements: BOOKING_DEFAULT_DURATIONS, allowsEnabled:true, allowsDisabled: true, defaultEnabled: false },
